                  ...
                  <div key={i}>
                    ...
                    <div className="space-y-1">
                      {section.points.map((point, j) => (
                        <p key={j} className="text-sm text-gray-700 leading-relaxed text-justify">
                          {point}
                        </p>
                      ))}
                    </div>
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="space-y-1">
                {course.areaOfSpecialization.areas.map((area, i) => (
                  <p key={i} className="text-sm text-gray-700">– {area}</p>
                ))}
              </div>
            </div>
          </div>
              ...
              <div className="space-y-6">
                {course.programmesDuration.sections.map((section, i) => (
                  <div key={i}>
                    ...
                    <div className="space-y-1">
                      {section.points.map((point, j) => (
                        <p key={j} className="text-sm text-gray-700">{point}</p>
                      ))}
                    </div>
                  </div>
                ))}
