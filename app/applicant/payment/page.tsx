...
import { LogOut, AlertCircle, DollarSign } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="border-yellow-500/50 bg-yellow-50">
          ...
          <CardContent className="text-yellow-800">
            <p className="mb-3">
              The payment system is currently under development. Available
            ...
            <p className="mt-4 text-sm">
              Payment processing will be enabled shortly. Please check back
              later or contact the admissions office for more information.
            </p>
          </CardContent>
        </Card>
