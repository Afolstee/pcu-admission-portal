...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await signup(formData.name, formData.email, formData.password, formData.phone_number);
          ...
          <div className="flex items-center justify-center">
            <Card className="w-full">
              <CardHeader className="space-y-2">
                ...
                <CardDescription>Join the admission portal to start your application</CardDescription>
              </CardHeader>
              <CardContent>
